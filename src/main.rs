use std::{env,fs::{self,File},process::exit,io::{prelude::*},path::Path};
...
fn main() {
    ...
    match args.len() {
        ...
        3 => {println!("Compressing {} into {}{}", &args[1].blue(), &args[2].red(), ".gz".red()); check_files(args);},
        _ => todo!()
    }
}
